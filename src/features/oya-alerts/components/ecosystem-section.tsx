      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="border-t border-command-foreground/15">
          {ECOSYSTEM_ROLES.map((item, index) => (
            <div
              key={item.title}
              className="grid grid-cols-2 w-full gap-6 md:gap-10 items-center justify-between py-5 border-b border-command-foreground/15 reveal hover:bg-command-foreground/3 transition-colors"
